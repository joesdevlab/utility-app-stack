...
test.describe("Apprentice Log - Authentication", () => {
  ...
  test("should show password strength requirements on sign up", async ({ page }) => {
    await page.getByText(/create account/i).click();

    // Password field should indicate minimum requirements
