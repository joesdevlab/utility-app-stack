  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <TradeVideoHero
        ...
        fallbackImage="https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=1600&q=80"
        badgeIcon={Car}
        badgeText="For Automotive Apprentices"
        title="Turbocharge Your"
        highlight="Logbook"
        description="Document your diagnostic, service, and repair work. AI converts your voice notes into MITO-compliant entries."
      />
