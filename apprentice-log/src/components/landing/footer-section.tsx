...
import { AppStoreBadgesCompact } from "@/components/app-store-badges";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl overflow-hidden shadow-lg shadow-orange-500/25">
          ...
          <div className="flex items-center gap-6">
            {/* App Store Badges */}
            <AppStoreBadgesCompact className="text-gray-600" />
